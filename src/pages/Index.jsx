...
const Index = () => {
  ...
  const handleManualAdjustment = () => {
    const startDateTime = new Date(`${adjustmentDate}T${adjustmentStartTime}`);
    const endDateTime = new Date(`${adjustmentDate}T${adjustmentEndTime}`);
    const secondsDiff = Math.floor((endDateTime - startDateTime) / 1000);
        ...
        <ModalContent>
          ...
          <ModalBody>
            ...
            <FormControl mt={4}>
              ...
              <Input type="time" value={adjustmentStartTime} onChange={(e) => setAdjustmentStartTime(e.target.value)} />
            </FormControl>
            <FormControl mt={4}>
              <FormLabel>終了時間</FormLabel>
              <Input type="time" value={adjustmentEndTime} onChange={(e) => setAdjustmentEndTime(e.target.value)} />
            </FormControl>
